...
/**
 * Display message in Corese GUI prefix fun: &lt;function://fr.inria.corese.gui.core.Callback&gt;
...
public class Callback {
    ...
    public IDatatype display(
            IDatatype dt1, IDatatype dt2, IDatatype dt3, IDatatype dt4, IDatatype dt5) {
