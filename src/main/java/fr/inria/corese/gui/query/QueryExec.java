...
/**
 * Evaluator of SPARQL query by KGRAM Implement KGRAM on top of Corese with Corese API, lightweight
 * version: Mappings SPARQLQuery
 *
...
public class QueryExec {
    ...
    protected boolean isListGroup = false, isDebug = false;
    ...
    /**
     * call after compile to prepare GUI order by use case: user edit order by clause and click Sort
     * button We sort Mappings again according to new order by clause
     */
    ...
    public Mappings SPARQLQuery(String squery, List<String> from, List<String> named)
