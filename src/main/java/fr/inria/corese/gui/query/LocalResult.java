...
public class LocalResult {
    ...
    /**
     * Log intermediate service and results for federated endpoint and mode=why Generate
     * LinkedResult for source selection query and results and for query rewrite with service clause
     */
